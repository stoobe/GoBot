...
class MyBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        logger.info(
            f"setup_hook start commands {[c.qualified_name for c in self.tree.walk_commands()]}")
        ...
        logger.info(
            f"setup_hook end commands:   {[c.qualified_name for c in self.tree.walk_commands()]}")
